...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultServices = [
        ...
        { id: 2, title: 'Customize Software Development', desc: 'Tailor-made enterprise software solutions built specifically for your business.', stat: '✓ Full Stack Tech', img: 'assets/owner_real_photo.jpg' },
        ...
        { id: 4, title: 'Personal 1-on-1 Training (Meet)', desc: 'Direct live 1-on-1 mentorship sessions on Google Meet for ads & coding.', stat: '✓ Live Google Meet', img: 'assets/owner_real_photo.jpg' },
        { id: 5, title: 'Corporate Team Training', desc: 'Up-skill your company team with advanced ads scaling & software engineering.', stat: '✓ Enterprise Teams', img: 'assets/owner_real_photo.jpg' }
    ];

    const defaultProjects = [
        { id: 301, title: 'TechCorp Website Redesign', subtitle: 'TechCorp Bangladesh', category: 'PROJECT', img: 'assets/owner_real_photo.jpg' },
        { id: 302, title: 'FoodBD Brand Identity', subtitle: 'FoodBD Limited', category: 'PROJECT', img: 'assets/owner_real_photo.jpg' },
        { id: 303, title: 'GreenEnergy Ad Campaign', subtitle: 'GreenEnergy Bangladesh', category: 'PROJECT', img: 'assets/owner_real_photo.jpg' },
        { id: 304, title: 'StyleHouse E-commerce', subtitle: 'StyleHouse BD', category: 'PROJECT', img: 'assets/owner_real_photo.jpg' }
    ];
    ...
    let services = JSON.parse(localStorage.getItem('be_services_v4')) || defaultServices;
    let projects = JSON.parse(localStorage.getItem('be_projects_v4')) || defaultProjects;
    ...
    function saveState() {
        localStorage.setItem('be_services_v4', JSON.stringify(services));
        localStorage.setItem('be_projects_v4', JSON.stringify(projects));
